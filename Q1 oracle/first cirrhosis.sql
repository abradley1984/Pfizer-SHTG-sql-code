select * from cirrhosis_info_11apr_22;

create table cirrhosis_info_12apr_22
as
with NASH as (
    SELECT x.patid
    FROM (
    ...
    cirrhosis as (select patid, 1 as cirrhosis from nash inner join cdm_60_etl.diagnosis ON diagnosis.patid = pats.patid
